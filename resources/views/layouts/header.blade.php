<header class="bg-gray-800 flex justify-between items-center h-20 fixed w-full top-0 ">
    <!-- Menú hamburguesa en el header -->
    <div class=" flex justify-between items-center gap-8">

        <button id="menu-button" class="text-white bg-teal p-2 w-24 flex items-center justify-center h-20">
        ...
        @auth
            <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                <img src="{{ asset('img/iconoHeader.png') }}" alt="Logo" class="h-8 w-8 mr-4">
            </x-nav-link>
        @endauth
        @guest
            <img src="{{ asset('img/iconoHeader.png') }}" alt="Logo" class="h-8 w-8">
        @endguest
    </div>
